...
const allMenuItems: MenuItem[] = [
  ...
  { title: "Planejamento Sistemático", url: "/planejamento", icon: Calendar, requiredRoles: ["admin", "gestor", "tecnico"] },
  { title: "Inventário Rápido", url: "/inventario", icon: ScanBarcode },
  { title: "Relatórios Financeiros", url: "/relatorios", icon: BarChart3, requiredRoles: ["admin", "gestor"] },
  { title: "Análise Visual", url: "/analise-visual", icon: BarChart3, requiredRoles: ["admin", "gestor"] },
  { title: "Desempenho Técnicos", url: "/desempenho", icon: Users, requiredRoles: ["admin", "gestor"] },
  { title: "Técnico Mobile", url: "/tecnico-mobile", icon: Smartphone, requiredRoles: ["admin", "tecnico"] },
...
export function Sidebar() {
  ...
  // Filtrar itens de menu baseado no role
  const menuItems = allMenuItems.filter(item => {
    if (!item.requiredRoles) return true; // Se não tem restrição, mostra para todos
                      ...
                      <TooltipTrigger asChild>
                        <SidebarMenuButton asChild>
                          <NavLink
                            ...
                            className={({ isActive }) =>
                              isActive
                                ? "flex items-center gap-3 px-4 py-3 rounded-xl bg-red-50 text-red-700 font-medium transition-all duration-200 mb-1 whitespace-normal"
                                : "flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-red-50 hover:text-red-700 transition-all duration-200 text-slate-700 mb-1 whitespace-normal"
                            }
                          >
